...
def lambda_handler(event, context):
    ...
    if responseSelect == "yes":
        ...
        appNotMessage = "The incident has been marked as a threat and authorities will be contacted immediately."
    elif responseSelect == "no":
        with conn:
            cur = conn.cursor()
