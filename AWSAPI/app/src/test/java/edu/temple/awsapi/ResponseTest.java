...
public class ResponseTest {
    ...
    public void setBodyArrayEqualsGetBodyArray() {
        ...
        try {
            ...
            assertEquals(jsonArray.get(0).toString().trim(), json_result1.get(0).toString().trim());
            assertEquals(jsonArray.get(1).toString().trim(), json_result1.get(1).toString().trim());
            ...
            assertEquals(jsonArray.get(0).toString().trim(), json_result2.get(0).toString().trim());
            assertEquals(jsonArray.get(1).toString().trim(), json_result2.get(1).toString().trim());
            assertEquals(jsonArray.toString(), result);
