...
class S3_Client():
    ...
    def __init__(self):
        self.session = boto3.Session(
            aws_access_key_id='AKIAJ6J4L32Z6ZJWCRWQ',
            aws_secret_access_key='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'
        )
    ...
    def upload_reg_file(self, file_name, bucket, object_name=None):
