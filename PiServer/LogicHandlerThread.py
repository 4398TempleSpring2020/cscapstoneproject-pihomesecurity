    ...
    def __init__(self, shared_resources):
        ...
        def run(self):
            while True:
                ...
                # if self.shared_resources.is_armed is True:   #this is in latest from LUKE
                # BELOW WAS IN LATEST FROM BREAKOUT ROOM THIS MORNING JON TYPED IN THE UPDATED LINES... 
                ...
                if record_incident is True:
                    ...
                    # log to text file
                    # self.shared_resources.db_conn.disconnect()  # disconnect handled in dbConn
"""                  
    def run(self):
        while True:
